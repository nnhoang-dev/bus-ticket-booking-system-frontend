...
function ProfileManagementForm({ userInfo }) {
  return (
          ...
          <div className="w-full border border-slate-300 rounded-xl p-3 flex flex-col md:flex-row">
            <div className="basis-1/3 flex flex-col p-2">
              ...
              <div className="mb-5 mt-8 text-center">
                <span className="cursor-pointer bg-slate-200 px-4 py-2 rounded-full hover:bg-slate-300">
                  Chọn ảnh
                </span>
              </div>
                ...
                <>
                  <div className="flex flex-row mb-3 items-center">
                    ...
                    <div className="basis-2/3">
                      : <span className="ml-3">{info.last_name}</span>
                    </div>
                  </div>
                  <div className="flex flex-row mb-3 items-center">
                    <div className="basis-1/3 text-slate-500">Tên</div>
                    <div className="basis-2/3">
                      : <span className="ml-3">{info.first_name}</span>
                    </div>
                  </div>
                  <div className="flex flex-row mb-3 items-center">
                    ...
                    <div className="basis-2/3">
                      : <span className="ml-3">{info.phone_number}</span>
                    </div>
                  </div>
                  <div className="flex flex-row mb-3 items-center">
                    <div className="basis-1/3 text-slate-500">Giới tính</div>
                    <div className="basis-2/3">
                      : <span className="ml-3">{info.gender}</span>
                    </div>
                  </div>
                  <div className="flex flex-row mb-3 items-center">
                  ...
                  <div className="flex flex-row mb-3 items-center">
                    ...
                    <div className="basis-2/3">
                      : <span className="ml-3">{info.date_of_birth}</span>
                    </div>
                  </div>
                  <div className="flex flex-row mb-3 items-center">
