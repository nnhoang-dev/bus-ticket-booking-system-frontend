...
function HomeBusLine(props) {
  return (
    <div className="py-20">
      <h3 className="text-center text-2xl font-bold text-green-700 mb-3">
        TUYẾN PHỔ BIẾN
      </h3>
      ...
      <div className="w-[80%] md:w-[60%] xl:w-[80%] 2xl:w-[60%] mx-auto mt-10 flex flex-col xl:flex-row justify-center items-center gap-8">
        <div className="basis-1/3 bus-line-card border border-slate-300 rounded-2xl flex flex-col shadow-2xl cursor-pointer">
          ...
          <div className="bus-line-info p-3 border-b border-slate-300">
            ...
            <p className="text-slate-500 text-[16px]">
              366km - 3 giờ 12 phút - 1/5/2024
            </p>
          </div>
          <div className="bus-line-info p-3">
            <div className="flex justify-between">
              <h5 className="text-green-800 font-semibold text-lg">
                Long Xuyên
              </h5>
              <p className="font-semibold">190.000đ</p>
            </div>
            <p className="text-slate-500 text-[16px]">
              186km - 5 giờ - 1/5/2024
            </p>
          </div>
        </div>
        <div className="basis-1/3 bus-line-card border border-slate-300 rounded-2xl flex flex-col shadow-2xl cursor-pointer">
